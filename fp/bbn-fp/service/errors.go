...
const instanceTerminatingMsg = "terminating the bbn-fp instance due to critical error"
...
func (ce *CriticalError) Error() string {
	return fmt.Sprintf("critical err on bbn-fp %s: %s", ce.fpBtcPk.MarshalHex(), ce.err.Error())
}
